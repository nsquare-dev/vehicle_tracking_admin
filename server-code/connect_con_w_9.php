<?php
    ...
    echo "<h2>TCP/IP Connection Write continuosly  Client 9</h2>\n";
    ...
    $defaultResponce = "+#RPT00,20180109,L,180122144659,N2237.4410E11403.2599,000,000,65535.0,39.3,0241A046\n";
    ...
    { 
        ...
        if (strlen($strResponce) >= 6) {
            ...
            if($receivedPacket === "++CTL"){                    
                $defaultResponce = "+#ACT$receivedEvent,20180109,L,180122144659,N2237.4410E11403.2599,000,000,65535.0,39.3,0241A046\n";                    
            }else if($receivedPacket === "++SET"){
                $defaultResponce = "+#ACS$receivedEvent,20180109,L,180122144659,N2237.4410E11403.2599,000,000,65535.0,39.3,0241A046\n";
            } else{
                $defaultResponce = "+#RPT00,20180109,L,180122144659,N2237.4410E11403.2599,000,000,65535.0,39.3,0241A046\n";
            }
         }else{
