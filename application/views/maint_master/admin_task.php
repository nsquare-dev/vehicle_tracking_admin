                        ...
                        <tbody>
                            <?php foreach ($userDetails as $key => $user) { ?>
                                <tr>
                                    ...
                                    <td >  
                                        <a href="<?php echo base_url("manageMaintenance/getMaintAdminTaskdetails/"); ?><?php echo encode($user['userId']); ?>"  data-repeater-create class="btn btn-info mt-repeater-add" title="View Details">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                </tr>
