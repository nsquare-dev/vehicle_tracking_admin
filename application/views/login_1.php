        ...
        <div class="logo">
            <a href="<?php echo base_url(); ?>welcome">
               <!-- <img src="<?php echo base_url(); ?>assets/pages/img/logo-big.png" alt="" />  -->
			     <h1 style="color:white"> E-Scooter </h1>
			</a>	 
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
            ...
            <!--<div class="alert alert-danger display-hide">
               ...
               <span id="errormsg" style="color:red"></span>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="Enter email" name="username" /> </div>
               <span id="email" style="color:red"></span>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Enter password" name="password" /> </div>
...
<!--                <div class="create-account">
                    <p>
                        ...
                        <a href="#" id="" class="">Create an account</a>
        ...
        <div class="copyright"> 2017 &copy; E-Scooter </div>
        <!--[if lt IE 9]>
